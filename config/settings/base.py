...
MIDDLEWARE = [
    ...
    "apps.common.middleware.IdempotencyKeyMiddleware",
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "eventshop"),
        "USER": os.environ.get("POSTGRES_USER", "eventshop"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "eventshop"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "EventShop API",
    "DESCRIPTION": "Event-Driven Order & Inventory Platform",
    "VERSION": "0.1.0",
